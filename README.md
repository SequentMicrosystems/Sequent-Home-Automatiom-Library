...
## Install
To download click <>Code > Download ZIP button from the main [page](https://github.com/SequentMicrosystems/Sequent-Home-Automation-Library), rename the uncompressed folder to "SM_Home_Automation" 
